...
const LikedVideos = () => {
  ...
  return (
    <div className="min-h-screen bg-white ml-15 dark:bg-zinc-950 text-black dark:text-white">
      <div className="flex pt-14">
        <main className="flex-1 px-4 md:px-6 py-6 md:ml-0">
          ...
          {videos.length === 0 ? (
            ...
            <div className="space-y-2">
              {videos.map(({ video }) => (
                <div
                  key={video.id}
                  className="flex gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-900 transition cursor-pointer"
                >
                  {/* THUMBNAIL */}
                  <div
                  ...
                  <button
                    ...
                    className="text-sm text-gray-500 hover:text-red-500 px-3 flex-shrink-0"
                  >
                    Remove
                  </button>
                </div>
