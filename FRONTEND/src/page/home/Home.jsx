  ...
  const Home = () => {
    ...
    return (
      <div className="min-h-screen lg:ml-15 bg-white dark:bg-zinc-950 text-black dark:text-white">
        {/* Header */}
  ...
  <p
    ...
    className="text-xs text-gray-600 dark:text-gray-400 mt-1 hover:underline cursor-pointer"
  >
    {video.user?.username}
  </p>
